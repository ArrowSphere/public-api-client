...
/**
 * Class AssetUploadUrlTest
 */
class AssetUploadUrlTest extends AbstractEntityTest
{
    public const CLASS_NAME = AssetUploadUrl::class;
    ...
    public function providerSerialization(): array
    {
        return [
            'standard' => [
                'fields'   => [
                    'uuid'  => '12341234-0000-bbbb-cccc-432143213421',
                    'image' => [
